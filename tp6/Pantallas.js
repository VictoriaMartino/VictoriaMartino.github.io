class App {
  constructor() {
    this.cantidadDePantallas = 25
      ...
      this.botonStart = new Boton(width/3, 600, 100, 50, "Volver", 0)
  ...
  dibujar() {
    ...
    if (this.pantalla == 0) {
      push()
        image(imagen[7], 0,0, windowWidth, windowHeight)
        textSize(30)
        fill(255)
      ...
      push()
        image(imagen[0], 0,0, windowWidth, windowHeight)
        textSize(20)
        fill(255);
      ...
      push()
        image(imagen[1], 0,0, windowWidth, windowHeight)
        textSize(20)
        fill(255);
      ...
      push()
        image(imagen[2], 0,0, windowWidth, windowHeight)
        textSize(20)
        fill(255);
      ...
      push()
        image(imagen[3], 0,0, windowWidth, windowHeight)
        textSize(20)
        fill(255);
      ...
      push()
        image(imagen[4], 0,0, windowWidth, windowHeight)
        textSize(20)
        fill(255);
      ...
      push()
        image(imagen[5], 0,0, windowWidth, windowHeight)
        textSize(20)
        fill(255);
      ...
      push()
        image(imagen[6], 0,0, windowWidth, windowHeight)
        textSize(20)
        fill(255);
      ...
      push()
        image(imagen[8], 0,0, windowWidth, windowHeight)
        textSize(20)
        fill(255);
      ...
      push()
        image(imagen[9], 0,0, windowWidth, windowHeight)
        textSize(20)
        fill(255);
      ...
      push()
        image(imagen[10], 0,0, windowWidth, windowHeight)
        textSize(20)
        fill(255);
      ...
      push()
        image(imagen[11], 0,0, windowWidth, windowHeight)
        textSize(20)
        fill(255);
      ...
      push()
        image(imagen[12], 0,0, windowWidth, windowHeight)
        textSize(20)
        fill(255);
      ...
      push()
        image(imagen[13], 0,0, windowWidth, windowHeight)
        textSize(20)
        fill(255);
      ...
      push()
        image(imagen[14], 0,0, windowWidth, windowHeight)
        textSize(20)
        fill(255);
      ...
      push()
        image(imagen[15], 0,0, windowWidth, windowHeight)
        textSize(20)
        fill(255)
        text("Perdiste", 500, 100);
      text("Oh No! las hermanastras lograron su cometido y el mesajero del rey no te vio. Se fue con la zapatilla y no pudiste probartela. \n Tu vida continuo igual como estaba.", 100, 500);
      pop()
        this.botonUniversal2.dibujar()
    } else if (this.pantalla == 19) {
      push()
        image(imagen[16], 0,0, windowWidth, windowHeight)
        textSize(20)
        fill(255);
      text("Ganaste", 500, 100);
      text("Lograste llegarar al living y el mensajero del rey confirmo que eres la dama que bailo con el principe, te casaste con el y vivieron felices para siempre.", 100, 500);
      pop()
        this.botonUniversal2.dibujar()
      ...
      push()
        ...
        textSize(20)
        fill(255)
        text("Alumno: Victoria Martino.", 500, 100)
        text("Legajo: 85114/3.", 500, 120);
        text("Comision: 5.", 500, 140);
        text("Profesor: Tobias Albirosa", 500, 160);
        pop()
        this.botonStart.dibujar()
    }
  }
    mouseClicked() {
      if (this.pantalla == 0) {
